...
CRYPTO_MARKET_REGISTRY: tuple[CryptoMarketSpec, ...] = (
    ...
    CryptoMarketSpec(
        ...
        status="adapter_code_exists_for_binance_futures_um_but_no_local_futures_data_confirmed",
    ),
    CryptoMarketSpec(
...
CRYPTO_SUPPORT_ROWS: tuple[CryptoSupportRow, ...] = (
    ...
    CryptoSupportRow(
        ...
        raw_data_available="no local futures/perpetual data confirmed",
        bar_types_available="none confirmed",
        trade_data_available="none confirmed",
        ...
        caveat="Binance Vision futures_um adapter code exists, but scanned historical data has no futures_um partitions",
        next_action="E2: controlled import plan for BTC/ETH/BNB/SOL perpetual bars plus metadata",
    ),
    CryptoSupportRow(
        exchange="BINANCE",
        market_type="crypto_delivery_futures",
