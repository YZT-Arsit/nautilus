"""Fill-synchronized execution adapter for open_close_histogram_short."""
...
class OpenCloseHistogramShortExecutionAdapter:
    ...
    def __init__(self, config: OpenCloseHistogramShortConfig) -> None:
        self._signals = OpenCloseHistogramShortStrategy(config)
