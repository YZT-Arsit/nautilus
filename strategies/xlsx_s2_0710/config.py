"""Typed configuration compiled from workbook row xlsx_s2_0710."""
...
class XlsxS20710Config(WorkbookParametricConfig):
    source_registry_id: str = 'xlsx_s2_0710'
