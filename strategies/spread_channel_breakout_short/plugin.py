"""Spread Channel Breakout short plugin wiring (feature specs + registry plugin).
...
from strategies.spread_channel_breakout_short.strategy import (
    _CLOSE,
    _HIGH,
    _LOW,
    _OPEN,
...
def build_specs(config: SpreadChannelBreakoutShortConfig) -> list[FeatureSpec]:
...
PLUGIN = StrategyPlugin(
    name="spread_channel_breakout_short",
    config_cls=SpreadChannelBreakoutShortConfig,
    strategy_cls=SpreadChannelBreakoutShortStrategy,
    build_specs=build_specs,
    default_config_path="strategies/spread_channel_breakout_short/config.yaml",
)
