"""Typed configuration compiled from workbook row xlsx_s2_0884."""
...
class XlsxS20884Config(WorkbookParametricConfig):
    source_registry_id: str = 'xlsx_s2_0884'
