"""Fill-synchronized execution adapter for trading_range_breakout_long."""
...
class TradingRangeBreakoutLongExecutionAdapter:
    ...
    def __init__(self, config: TradingRangeBreakoutLongConfig) -> None:
        self._signals = TradingRangeBreakoutLongStrategy(config)
