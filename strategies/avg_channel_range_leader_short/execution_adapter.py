"""Fill-synchronized execution adapter for avg_channel_range_leader_short."""
...
class AvgChannelRangeLeaderShortExecutionAdapter:
    ...
    def __init__(self, config: AvgChannelRangeLeaderShortConfig) -> None:
        self._signals = AvgChannelRangeLeaderShortStrategy(config)
