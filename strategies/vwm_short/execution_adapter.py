"""Fill-synchronized execution adapter for vwm_short."""
...
from strategies.vwm_short.strategy import VwmShortConfig, VwmShortStrategy


class VwmShortExecutionAdapter:
    """Preserve legacy signals while making actual position fill-owned."""

    def __init__(self, config: VwmShortConfig) -> None:
        self._signals = VwmShortStrategy(config)
