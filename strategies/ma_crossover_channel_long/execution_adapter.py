"""Fill-synchronized execution adapter for ma_crossover_channel_long."""
...
class MaCrossoverChannelLongExecutionAdapter:
    ...
    def __init__(self, config: MaCrossoverChannelLongConfig) -> None:
        self._signals = MaCrossoverChannelLongStrategy(config)
