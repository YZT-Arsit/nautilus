"""Fill-synchronized execution adapter for three_ema_crossover_short."""
...
class ThreeEmaCrossoverShortExecutionAdapter:
    ...
    def __init__(self, config: ThreeEmaCrossoverShortConfig) -> None:
        self._signals = ThreeEmaCrossoverShortStrategy(config)
