"""Fill-synchronized execution adapter for avg_channel_range_leader_long."""
...
class AvgChannelRangeLeaderLongExecutionAdapter:
    ...
    def __init__(self, config: AvgChannelRangeLeaderLongConfig) -> None:
        self._signals = AvgChannelRangeLeaderLongStrategy(config)
