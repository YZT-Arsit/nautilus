"""Spread Channel Breakout long strategy configuration (parameters only).

Pure dataclass: no Nautilus, no pandas, no feature_engine / strategy_framework
imports. Ported from the TradeBlazer ``SpreadChannelBreakout_L`` system — the long
mirror of ``SpreadChannelBreakout_S``. A channel-breakout on the *spread* between
two instruments (``Data0*Factor0 - Data1*Factor1``): long the spread on an upside
channel breakout, reverse/stop on the downside channel.
...
class SpreadChannelBreakoutLongConfig:
    """User-facing parameters for the Spread Channel Breakout long strategy."""
