"""Spread Channel Breakout long plugin wiring (feature specs + registry plugin).
...
from strategies.spread_channel_breakout_long.strategy import (
    _CLOSE,
    _HIGH,
    _LOW,
    _OPEN,
...
def build_specs(config: SpreadChannelBreakoutLongConfig) -> list[FeatureSpec]:
...
PLUGIN = StrategyPlugin(
    name="spread_channel_breakout_long",
    config_cls=SpreadChannelBreakoutLongConfig,
    strategy_cls=SpreadChannelBreakoutLongStrategy,
    build_specs=build_specs,
    default_config_path="strategies/spread_channel_breakout_long/config.yaml",
)
