"""Fill-synchronized execution adapter for vwm_long."""
...
from strategies.vwm_long.strategy import VwmLongConfig, VwmLongStrategy


class VwmLongExecutionAdapter:
    """Preserve legacy signals while making actual position fill-owned."""

    def __init__(self, config: VwmLongConfig) -> None:
        self._signals = VwmLongStrategy(config)
