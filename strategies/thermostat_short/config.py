"""Thermostat short strategy configuration (parameters only).

Pure dataclass: no Nautilus, no pandas, no feature_engine / strategy_framework
imports. Ported from the TradeBlazer ``Thermostat_S`` system — a regime-switching
short-only system. A Choppy Market Index (CMI) splits the market into a *swing*
...
class ThermostatShortConfig:
    """User-facing parameters for the Thermostat short strategy."""
