"""Reference Deviation System long plugin wiring (feature specs + registry plugin).
...
def build_specs(config: ReferenceDeviationLongConfig) -> list[FeatureSpec]:
...
PLUGIN = StrategyPlugin(
    name="reference_deviation_long",
    config_cls=ReferenceDeviationLongConfig,
    strategy_cls=ReferenceDeviationLongExecutionAdapter,
    build_specs=build_specs,
    default_config_path="strategies/reference_deviation_long/config.yaml",
)
