"""Fill-synchronized execution adapter for Reference Deviation long."""
...
class ReferenceDeviationLongExecutionAdapter:
    """Keep signal generation unchanged while making position fill-owned."""

    def __init__(self, config: ReferenceDeviationLongConfig) -> None:
        self._signals = ReferenceDeviationLongStrategy(config)
        self._state = LegacyExecutionState(
