"""JailBreak short plugin wiring (feature specs + registry plugin).
...
from strategies.jailbreak_short.execution_adapter import JailBreakShortExecutionAdapter
from strategies.jailbreak_short.strategy import (
    _CLOSE,
    _HIGH,
    _LOW,
    _OPEN,
...
def build_specs(config: JailBreakShortConfig) -> list[FeatureSpec]:
...
PLUGIN = StrategyPlugin(
    name="jailbreak_short",
    config_cls=JailBreakShortConfig,
    strategy_cls=JailBreakShortExecutionAdapter,
    build_specs=build_specs,
    default_config_path="strategies/jailbreak_short/config.yaml",
)
